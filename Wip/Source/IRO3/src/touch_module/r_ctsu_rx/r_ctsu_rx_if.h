 ...
 *
 ***********************************************************************************************************************/
#ifndef R_CTSU_RX_IF_H_
#define R_CTSU_RX_IF_H_
/***********************************************************************************************************************
 Includes
 ***********************************************************************************************************************/
#include "platform.h"
...
typedef enum e_ctsu_err
{
    ...
    CTSU_ERR_INVALID_PARAM = 0x0001,        ///< Received invalid information for important parameter.
    CTSU_ERR_INSUFFICIENT_MEMORY = 0x0002,  ///< No more control blocks available.
    CTSU_ERR_CTSU_OPERATIONAL = 0x0004,     ///< Attempted operation while CTSU is performing scan measurement.
    CTSU_ERR_LOCKED = 0x0004,               ///< Attempted to use a locked handle.
    CTSU_ERR_INVALID_CMD = 0x0008,          ///< Command requested is invalid.
    CTSU_ERR_CTSU_SC_OVF = 0x0010,          ///< Sensor count overflowed when performing CTSU scan.
    CTSU_ERR_CTSU_RC_OVF = 0x0020,          ///< Reference count overflowed when performing CTSU scan.
    CTSU_ERR_CTSU_ICOMP = 0x0040,           ///< Abnormal TSCAP voltage.
    CTSU_ERR_CORRECTION_FACTOR = 0x0080,    ///< Failed to calculate correction factor.
...
{
    uint32_t handle_num;  ///< Handle identifier which generated this event.
...
typedef struct st_ctsu_cfg
{
    ...
    fit_callback_t p_callback;                              ///< Pointer to callback function to be used for event notifications.
