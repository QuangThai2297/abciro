 ...
 ***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_touch_rx_private.h
* Version      : 1.0
* Description  : This is a private file. No need to include this file in include paths.
***********************************************************************************************************************/
/*******************************************************************************************************************//**
 * @defgroup PRIVATE Middleware Control structures (private)
 * @brief Header file containing structures used by the middleware .
 * @{
 * This is a private file. No need to include this file in compiler-include path.
 ***********************************************************************************************************************/
/***********************************************************************************************************************
...
#ifndef SRC_R_TOUCH_RX_PRIVATE_H_
#define SRC_R_TOUCH_RX_PRIVATE_H_
...
typedef struct st_touch_ctrl_blk
{
    ...
    const uint32_t ctsu_hw_id;              ///< Lower level CTSU H/W handle identifier.
    ...
    sensor_info_t * p_sensor;               ///< Pointer to touch related parameters for each sensor.
    ...
    bool multi_touch;
    fit_callback_t p_callback[TOUCH_CFG_MAX_UPPER_LAYER_CALLBACKS]; ///< Callback function to use for upper level notification.
...
}touch_ctrl_blk_t;                          ///< Refer @ref st_touch_ctrl_blk
...
{
    uint32_t const ctsu_hw_id;          ///< CTSU Hardware Identifier to use.
...
#endif /* SRC_R_TOUCH_RX_PRIVATE_H_ */
/*******************************************************************************************************************//**
 * @} (end defgroup CONFIG)
 ***********************************************************************************************************************/
