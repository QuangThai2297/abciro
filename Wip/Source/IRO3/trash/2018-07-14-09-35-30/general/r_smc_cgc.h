...
#define _0001_CGC_SUBSTPWT_WAIT             (0x0001U) /* Wait time for 5 sub clock cycles */
#define _00000001_CGC_SUBOSCWT_WAIT         (0x00000001UL) /* Wait time for sub clock stable (0.5s)*/
